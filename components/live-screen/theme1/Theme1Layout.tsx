...
export default function Theme1Layout({ data, isPreview = false }: { data?: any; isPreview?: boolean }) {
  ...
  const defaultCommodities = [
    { metal: "GOLD", metal_name: "Gold Bar 999", purity: 999, unit: 1, weight: "GM", buyCharge: 0, buyPremium: 2, sellCharge: 0, sellPremium: 2 },
    { metal: "GOLD", metal_name: "Gold Coin", purity: 916, unit: 8, weight: "GM", buyCharge: 0, buyPremium: 10, sellCharge: 0, sellPremium: 10 },
  ];
      ...
      <Grid container spacing={10} sx={{ minHeight: "100%", justifyContent: "space-between", flexWrap: "wrap", zIndex: 1, position: "relative", m: 0, p: "0 2vw", alignItems: "center", width: "100%" }}>
        <Grid item xs={12} md={6} sx={{ display: "flex", alignItems: "center", flexDirection: "column", justifyContent: "space-between", padding: "1vw", gap: "1vw" }}>
          <Box sx={{ height: "auto", width: { xs: "40vw", sm: "18vw" }, marginBottom: { xs: "20px", sm: "0vw" } }}>
            {showLogo ? (
              <img src={merchant?.logo || "/images/theme1-logo.svg"} alt={merchant?.companyName || "Dipanjali"} style={{ width: "100%", height: "auto", objectFit: "contain" }} />
            ) : showName ? (
