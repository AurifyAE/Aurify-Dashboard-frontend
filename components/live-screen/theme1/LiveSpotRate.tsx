...
const LiveSpotRate = ({ goldData, silverData, colors = {} }: LiveSpotRateProps) => {
  ...
  const getColors = (dir: string) => {
    if (dir === "rise") return { bgColor: "#4dbf00", border: "1px solid #008f0c", color: "white" };
    if (dir === "fall") return { bgColor: "#FF0040", border: "1px solid #ff3366", color: "white" };
  ...
  const PricePulse = ({ label, value, dir }: { label: string; value: any; dir: string }) => {
    ...
    return (
      ...
      >
        ...
        <Typography
          sx={{
            fontSize: { xs: "18px", sm: "2.5vw", md: "1.8vw", lg: "2.4vw", xl: "2.4vw" },
            fontWeight: 800,
  ...
  const MetalPanel = ({ data, bidDir, askDir, theme }: { data: any; bidDir: string; askDir: string; theme: string }) => {
    ...
    return (
      ...
      >
        ...
        <Box sx={{ fontSize: { xs: "15px", sm: "2.5vw", md: "1.8vw", lg: "1.5vw", xl: "1.2vw" }, color: "#fff", fontWeight: "700" }}>
  ...
  return (
    <Box sx={{ display: "grid", gap: "1vw", width: "100%", alignItems: "end", marginTop: { xs: "20px", sm: "0vw" }, gridTemplateColumns: { xs: "1fr" } }}>
